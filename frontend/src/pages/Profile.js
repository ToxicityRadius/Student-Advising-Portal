    ...
    const fetchProfile = async () => {
      try {
        ...
        setFormData({
          ...
          program: p.program || "",
          curriculum_id: p.curriculum_id !== null && p.curriculum_id !== undefined ? String(p.curriculum_id) : "",
          student_type: p.student_type || "",
          year_level: p.current_year_level !== null && p.current_year_level !== undefined ? String(p.current_year_level) : (p.year_level || ""),
