...
const Checklist = () => {
  ...
  return (
    ...
    >
      <aside
        className={`checklist-sidebar ${mobileMenuOpen ? "open" : ""}`}
        style={{
          width: SIDEBAR_W,
          background: "#fff",
          display: "flex",
      ...
      {mobileMenuOpen && (
        <button
          type="button"
          className="checklist-mobile-overlay"
      ...
      <div
        className="checklist-main-shell"
        style={{
          flex: 1,
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <button
              type="button"
              className="checklist-mobile-menu-btn"
            ...
            >
              ...
              <span style={{ color: "#111", fontWeight: 800 }}>CHECKLIST</span>
            </div>
          </div>
        ...
        >
          <div className="checklist-page">
            ...
            {loading ? (
              ...
              <section className="checklist-panel checklist-error">
                {error}
              </section>
            ) : (
              <>
