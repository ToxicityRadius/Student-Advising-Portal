...
const ChecklistWhiteIcon = ({ size = 40 }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
    <rect x="3" y="3" width="34" height="34" rx="5" stroke="white" strokeWidth="2.5" />
    <path
      d="M11 20l6 6L29 13"
      stroke="white"
      strokeWidth="2.5"
...
const Dashboard = () => {
  ...
  const progressPercent = totalUnits > 0 ? Math.round((unitsCredited / totalUnits) * 100) : 0;
  ...
  const semesterLabel = (() => {
    const termLabel = currentTerm
      ? { 1: '1st Semester', 2: '2nd Semester', 3: 'Summer' }[currentTerm.semester] ||
          ...
          <>
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 800, fontSize: '0.92rem', color: '#222' }}>
                  {unitsCredited} UNITS
                </span>
              </div>
                  ...
                  >
                    ...
                    {hasSems && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <button
                          onClick={() => setSemPage((p) => Math.min(sems.length - 1, p + 1))}
                          disabled={semPage === sems.length - 1}
                          style={{
                            background: 'none',
                            border: 'none',
                            cursor: semPage === sems.length - 1 ? 'not-allowed' : 'pointer',
                            fontSize: '1.1rem',
                  ...
                  >
                    ...
                    >
                      ...
                      {current && (
                        <span
                          style={{
                            background: current.status === 'In Progress' ? '#FFC107' : '#2ecc71',
                            color: '#fff',
                            borderRadius: 999,
                            padding: '5px 18px',
                            fontSize: '0.82rem',
                          ...
                          {current.courses.map((c, i) => (
                            <tr key={i}>
                              ...
                              >
                                ...
                                >
                                  {c.grade || (c.status === 'pending' ? '\u2014' : c.status)}
                                </span>
                              </td>
                            </tr>
                          ))}
