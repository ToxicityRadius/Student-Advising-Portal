...
const StudentShell = ({
  ...
  return (
    ...
    >
      <aside
        className={`${shellClassPrefix}-sidebar ${mobileMenuOpen ? "open" : ""}`}
        style={{
          width: SIDEBAR_W,
          background: "#fff",
          display: "flex",
      ...
      >
        ...
        >
          ...
          {(() => {
            ...
            return (
              ...
              >
                {yearLevel ? <Tag label={formatYearLevel(yearLevel)} /> : <Tag label="—" />}
        ...
        <nav style={{ flex: 1, paddingTop: 8 }}>
          ...
          <SideNavItem
            active={activeNav === "subjects"}
            icon={imgIcon(goldBookImg)}
            label="Available Subjects"
            to="/subjects"
            badge={subjectsBadgeCount > 0 ? subjectsBadgeCount : undefined}
          />
          <SideNavItem
      ...
      {mobileMenuOpen && (
        <button
          type="button"
          className={`${shellClassPrefix}-mobile-overlay`}
      ...
      <div
        className={`${shellClassPrefix}-main-shell`}
        style={{
          flex: 1,
      ...
      >
        <header
          className={`${shellClassPrefix}-topbar`}
          style={{
            background: YELLOW,
            height: 70,
            flexShrink: 0,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <button
              type="button"
              className={`${shellClassPrefix}-mobile-menu-btn`}
            ...
            >
              ...
              <span style={{ color: "#111", fontWeight: 800 }}>{pageLabel}</span>
            </div>
          </div>
