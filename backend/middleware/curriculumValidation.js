...
exports.createCurriculumValidation = [
  ...
  positiveIntBody('programId'),
];

// PUT /api/curriculums/:id — update a curriculum
exports.updateCurriculumValidation = [
  positiveIntParam('id'),
  body('name').optional().trim().notEmpty().withMessage('Curriculum name cannot be empty'),
  positiveIntBody('programId'),
];
...
exports.addCourseToCurriculumValidation = [
  ...
  positiveIntBody('courseId', { required: true }).withMessage(
...
exports.addEquivalencyValidation = [
  ...
  body('equivalentCourseId')
    ...
    .toInt(),
  positiveIntBody('ownerProgramId'),
];
