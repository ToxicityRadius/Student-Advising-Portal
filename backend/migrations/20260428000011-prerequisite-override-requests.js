...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('prerequisite_override_requests', ['status'], {
      name: 'idx_prereq_override_status',
    });
    await queryInterface.addIndex('prerequisite_override_requests', ['studentAcademicRecordId'], {
      name: 'idx_prereq_override_sar',
    });
    await queryInterface.addIndex('prerequisite_override_requests', ['studyPlanVersionId'], {
